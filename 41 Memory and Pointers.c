...
You would like to know how far behind the highest-scoring person everyone else is in order to
know whether you still have a chance at winning. 
...
The function behind should replace the scores stored in the array with the number of points by
